...
def create_runtime_agent(config: Config, llm_client_factory: Any=None, **kwargs: Any) -> Agent:
    return create_agent(AgentAssemblyRequest(config=config, llm_client_factory=llm_client_factory, **kwargs))
